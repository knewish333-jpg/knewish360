      ...
      <div className="max-w-7xl mx-auto">
        ...
        >
          ...
          <p className="text-primary-foreground/95 mb-10 max-w-2xl mx-auto text-xl leading-relaxed font-bold">
            Our expert team is ready to discuss your project and provide a free
            consultation. Reach out to us today and take the first step towards
