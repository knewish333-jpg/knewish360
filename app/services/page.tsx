...
const allServices = [
  {
    ...
    description:
      "Seamless office moving with minimal downtime and professional handling of all equipment.",
    details:
  ...
  },
  {
    ...
    description:
      "Complete residential moving services with care for your belongings and peace of mind.",
    details:
  ...
  },
  {
    ...
    description:
      "Professional solar panel installation for sustainable energy solutions.",
    details:
  ...
  },
  {
    ...
    description:
      "Transform your space with expert renovation services and quality craftsmanship.",
    details:
  ...
  },
  {
    ...
    description:
      "Safe and reliable electrical installation, repair, and maintenance services.",
    details:
  ...
  },
  {
    ...
    description:
      "Expert cooling system repair, maintenance, and installation for your comfort.",
    details:
  ...
  },
  {
    ...
    description:
      "Creative and functional interior design solutions tailored to your style.",
    details:
  ...
  },
  {
    ...
    description:
      "Modern lighting installations for enhanced ambiance and energy efficiency.",
    details:
  ...
  return (
    ...
    >
      ...
      <div className="p-8">
        ...
        {/* Features */}
        <div className="mb-6">
          <h4 className="font-heading font-semibold text-foreground mb-4 text-lg">
            Key Features:
          </h4>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          >
            ...
            <p className="text-lead max-w-4xl mx-auto mb-8">
              From home making to shifting, Knewish360 stays with the client at
          ...
          <div className="bg-card border border-primary/20 rounded-xl p-8 sm:p-12 mb-20 backdrop-blur-sm">
            ...
            <p className="text-lg leading-relaxed text-muted-foreground">
              <span className="text-primary font-heading font-bold text-xl">
                "From home making to shifting, this company stays with the
                client."
              </span>{" "}
              At Knewish360, we believe that every project is more than just a
              service—it's a partnership. Whether you're moving to a new home,
              renovating your space, or installing sustainable solutions, we're
              committed to being with you at every step, ensuring excellence and
