import { ArrowRight, Mail, Phone, MapPin, ExternalLink, MessageCircle } from "lucide-react";
        ...
        <div className="grid lg:grid-cols-2 gap-10 lg:gap-16 items-center">
          ...
          <div className="text-center lg:text-left">
            ...
            <p className="text-muted-foreground text-base md:text-lg mb-8 md:mb-10 max-w-xl mx-auto lg:mx-0">
              Fill out our quick form and our team will get back to you within 24 hours
            ...
            <div className="p-4 md:p-6 bg-card rounded-lg border border-border hidden md:block">
              <div className="flex items-center gap-4">
                ...
                <div className="text-left">
                  <div className="text-foreground font-semibold">Free Consultation</div>
          ...
          <div className="bg-card p-6 md:p-10 rounded-lg border border-border text-center">
            ...
            <p className="text-muted-foreground mb-6 md:mb-8 text-sm md:text-base">
              Click the button below to fill out our quick form. We'll review your 
              requirements and get back to you with a customized solution.
            </p>
            ...
            <div className="mt-6 md:mt-8 pt-6 md:pt-8 border-t border-border">
              ...
              <div className="flex flex-col sm:flex-row gap-3 justify-center">
                <a href="tel:+923211234567">
                  <Button variant="outline" size="sm" className="w-full sm:w-auto border-border hover:border-primary hover:text-primary">
