...
const HeroSection = ({ onGetQuote }: HeroSectionProps) => {
  ...
  return (
    ...
    >
      ...
      <div
        className="absolute bottom-1/4 right-1/4 w-32 md:w-64 h-32 md:h-64 bg-primary/5 rounded-full blur-2xl animate-float"
      ...
      <div className="container mx-auto px-4 md:px-6 relative z-10">
        <div className="max-w-4xl mx-auto text-center lg:text-left lg:mx-0">
          ...
          {/* Main Heading */}
          <h1
            className="text-3xl sm:text-4xl md:text-5xl lg:text-7xl font-bold text-foreground leading-tight mb-4 md:mb-6 opacity-0 animate-fade-in-up"
          ...
          {/* Subheading */}
          <p
            className="text-base md:text-lg lg:text-xl text-muted-foreground max-w-2xl mx-auto lg:mx-0 mb-8 md:mb-10 opacity-0 animate-fade-in-up px-2 md:px-0"
            style={{ animationDelay: "0.6s" }}
          >
            From relocation to renovation, Solar Panels Cleaning Services to
            electrical services — we handle everything so you can focus on what
            matters most.
          </p>

          {/* CTA Buttons */}
          <div
            className="flex flex-col sm:flex-row gap-3 md:gap-4 justify-center lg:justify-start opacity-0 animate-fade-in-up"
          ...
          {/* Stats */}
          <div
            className="grid grid-cols-3 gap-4 md:gap-8 mt-12 md:mt-16 pt-8 md:pt-16 border-t border-border/50 opacity-0 animate-fade-in-up max-w-lg mx-auto lg:mx-0 lg:max-w-none"
