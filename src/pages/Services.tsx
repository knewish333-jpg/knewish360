...
import { 
  Truck, Sun, Home, Zap, Wind, Wrench, PaintBucket, 
  Droplets, Shield, ArrowLeft, Phone 
} from "lucide-react";
...
const allServices = [
  {
    ...
    features: ["Packing & Unpacking", "Secure Transport", "Office Setup", "Furniture Assembly", "Insurance Coverage"],
  },
  {
    icon: Sun,
    title: "Solar Panel Installation",
    description:
      "Harness the power of the sun with our expert solar panel installation and maintenance services. Reduce your electricity bills and carbon footprint.",
    features: ["Site Assessment", "Panel Installation", "Grid Connection", "Maintenance Plans", "Net Metering Setup"],
  },
  {
    icon: Home,
    ...
    features: ["Interior Design", "Kitchen & Bath", "Full Remodeling", "Flooring & Tiling", "Custom Cabinetry"],
  },
  {
    icon: Zap,
    ...
    features: ["Wiring & Rewiring", "Panel Upgrades", "Safety Inspections", "LED Installation", "Emergency Repairs"],
  },
  {
    icon: Wind,
    ...
    features: ["AC Installation", "Regular Maintenance", "Emergency Repairs", "Gas Refilling", "Duct Cleaning"],
  },
  {
    icon: Wrench,
    ...
    features: ["Plumbing", "Carpentry", "Door/Window Repairs", "Lock Installation", "General Fixes"],
  },
  {
    icon: PaintBucket,
    ...
    features: ["Interior Painting", "Exterior Painting", "Wall Texturing", "Waterproofing", "Color Consultation"],
  },
  {
    icon: Droplets,
    ...
    features: ["Leak Repairs", "Pipe Installation", "Water Heater", "Bathroom Fitting", "Drainage Solutions"],
  },
  {
    icon: Shield,
    title: "Security Systems",
    description:
      "Protect your home and business with our comprehensive security system installation and monitoring services.",
    features: ["CCTV Installation", "Alarm Systems", "Access Control", "Intercom Systems", "Remote Monitoring"],
  },
];
        ...
        <div className="container mx-auto px-4 md:px-6">
          <div className="flex items-center justify-between h-16 md:h-20">
            ...
            <div className="flex items-center gap-2 md:gap-4">
              <Link to="/">
                <Button variant="outline" size="sm" className="border-border hover:bg-secondary text-xs md:text-sm">
        ...
        <div className="container mx-auto px-4 md:px-6 relative z-10">
          <div className="text-center max-w-3xl mx-auto">
            ...
            <p className="text-muted-foreground text-base md:text-lg lg:text-xl px-4 md:px-0">
              From relocation to renovation, we offer 360° solutions for all your 
              home and office needs. Professional service, guaranteed satisfaction.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="py-12 md:py-16 bg-card border-t border-border">
        <div className="container mx-auto px-4 md:px-6 text-center">
          ...
          <p className="text-muted-foreground mb-6 md:mb-8 max-w-2xl mx-auto text-sm md:text-base">
            Can't find exactly what you're looking for? Contact us and we'll create 
            a custom package tailored to your specific needs.
          </p>
          <Button
            onClick={() => setIsQuoteModalOpen(true)}
